    ...
    public void actionPerformed(ActionEvent e) {
        if(e.getSource()==bt1){
            ...
            try {
                ...
                String q="select * from bookchapter where Name='"+name+"'";
            ...
            try {
                ConnectionClass obj=new ConnectionClass();
                String q="select * from bookchapter where CorrespondingAuthor='"+corrAuth+"'";
                ResultSet rest=obj.stm.executeQuery(q);
            while(rest.next()){
                y[i][j++]=rest.getString("Name");
                y[i][j++]=rest.getString("CorrespondingAuthor");
            ...
            try {
                ConnectionClass obj=new ConnectionClass();
                String q="select * from bookchapter where CoAuthorExternal='"+coAuthEx+"'";
                ResultSet rest=obj.stm.executeQuery(q);
            while(rest.next()){
                y[i][j++]=rest.getString("Name");
                y[i][j++]=rest.getString("CorrespondingAuthor");
