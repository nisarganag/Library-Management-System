    ...
    public void actionPerformed(ActionEvent e) {
        if(e.getSource()==bt1){
            ...
            try {
                ...
                String q="select * from bookchapter where Name like '%"+name+"%'";
            ...
            try {
                ConnectionClass obj=new ConnectionClass();
                String q="select * from bookchapter where CorrespondingAuthor like '%"+corrAuth+"%'";
                ResultSet rest=obj.stm.executeQuery(q);
            while(rest.next()){
                y[i][j++]=rest.getString("Name");
                y[i][j++]=rest.getString("CorrespondingAuthor");
            ...
            try {
                ConnectionClass obj=new ConnectionClass();
                String q="SELECT * FROM bookchapter WHERE CoAuthorInternal LIKE '%" + coAuthIn + "%'";
                ResultSet rest=obj.stm.executeQuery(q);
            while(rest.next()){
                y[i][j++]=rest.getString("Name");
                y[i][j++]=rest.getString("CorrespondingAuthor");
            ...
            try {
                ConnectionClass obj=new ConnectionClass();
                String q="select * from bookchapter where CoAuthorExternal like '%"+coAuthEx+"%'";
                ResultSet rest=obj.stm.executeQuery(q);
            while(rest.next()){
                y[i][j++]=rest.getString("Name");
                y[i][j++]=rest.getString("CorrespondingAuthor");
            ...
            try {
                ConnectionClass obj=new ConnectionClass();
                String q="select * from bookchapter where PageNumber='"+pgno+"'";
                ResultSet rest=obj.stm.executeQuery(q);
            while(rest.next()){
                y[i][j++]=rest.getString("Name");
                y[i][j++]=rest.getString("CorrespondingAuthor");
            ...
            try {
                ConnectionClass obj=new ConnectionClass();
                String q="select * from bookchapter where ChapterNumber='"+chapno+"'";
                ResultSet rest=obj.stm.executeQuery(q);
            while(rest.next()){
                y[i][j++]=rest.getString("Name");
                y[i][j++]=rest.getString("CorrespondingAuthor");
            ...
            try {
                ConnectionClass obj=new ConnectionClass();
                String q="select * from bookchapter where ISBNNumber='"+isbnno+"'";
                ResultSet rest=obj.stm.executeQuery(q);
            while(rest.next()){
                y[i][j++]=rest.getString("Name");
                y[i][j++]=rest.getString("CorrespondingAuthor");
            ...
            try {
                ConnectionClass obj=new ConnectionClass();
                String q="select * from bookchapter where Date between '"+date1+"' and '"+date2+"'";
                ResultSet rest=obj.stm.executeQuery(q);
            while(rest.next()){
                y[i][j++]=rest.getString("Name");
                y[i][j++]=rest.getString("CorrespondingAuthor");
