...
import java.sql.*;
public class AddBookChapters extends JFrame implements ActionListener{
    ...
    AddBookChapters(){
        ...
        bt1=new JButton("Add Book Chapter");
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if(e.getSource()==bt1){
            try {
                ...
                String s="insert into bookchapter(Name,CorrespondingAuthor,CoAuthorInternal,CoAuthorExternal,PageNumber,ChapterNumber,ISBNNumber,Date) values('"+name+"','"+corrAuth+"','"+coAuthIn+"','"+coAuthEx+"','"+pgno+"','"+chapno+"','"+isbnno+"','"+date+"')";
